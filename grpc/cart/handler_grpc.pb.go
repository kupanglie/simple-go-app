...
type UserHandlerClient interface {
	Add(ctx context.Context, in *cart_proto.AddRequest, opts ...grpc.CallOption) (*cart_proto.AddResponse, error)
	Find(ctx context.Context, in *cart_proto.FindRequest, opts ...grpc.CallOption) (*cart_proto.FindResponse, error)
	Delete(ctx context.Context, in *cart_proto.DeleteRequest, opts ...grpc.CallOption) (*cart_proto.DeleteResponse, error)
}
...
func (c *userHandlerClient) Add(ctx context.Context, in *cart_proto.AddRequest, opts ...grpc.CallOption) (*cart_proto.AddResponse, error) {
	out := new(cart_proto.AddResponse)
...
func (c *userHandlerClient) Find(ctx context.Context, in *cart_proto.FindRequest, opts ...grpc.CallOption) (*cart_proto.FindResponse, error) {
	out := new(cart_proto.FindResponse)
...
func (c *userHandlerClient) Delete(ctx context.Context, in *cart_proto.DeleteRequest, opts ...grpc.CallOption) (*cart_proto.DeleteResponse, error) {
	out := new(cart_proto.DeleteResponse)
...
type UserHandlerServer interface {
	Add(context.Context, *cart_proto.AddRequest) (*cart_proto.AddResponse, error)
	Find(context.Context, *cart_proto.FindRequest) (*cart_proto.FindResponse, error)
	Delete(context.Context, *cart_proto.DeleteRequest) (*cart_proto.DeleteResponse, error)
...
func (UnimplementedUserHandlerServer) Add(context.Context, *cart_proto.AddRequest) (*cart_proto.AddResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedUserHandlerServer) Find(context.Context, *cart_proto.FindRequest) (*cart_proto.FindResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Find not implemented")
}
func (UnimplementedUserHandlerServer) Delete(context.Context, *cart_proto.DeleteRequest) (*cart_proto.DeleteResponse, error) {
...
func _UserHandler_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserHandlerServer).Add(ctx, req.(*cart_proto.AddRequest))
	}
...
func _UserHandler_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserHandlerServer).Find(ctx, req.(*cart_proto.FindRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserHandler_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(cart_proto.DeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserHandlerServer).Delete(ctx, req.(*cart_proto.DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
